...
export default function Heading({
  ...
  return (
    <div className="flex w-full items-center justify-center xl:justify-between relative h-60">
      ...
      <h3 className="z-10 px-6 font-bold text-white text-7xl sm:text-8xl md:text-9xl lg:text-[200px] text-center uppercase">
        {title}
      </h3>
      <div className="xl:w-1/4 relative h-full">
        ...
        {link && (
          <a
            href={link}
            className="text-white font-josefin font-bold xl:text-black absolute bottom-10 xl:bottom-24 xl:right-36 flex gap-2 uppercase"
          >
